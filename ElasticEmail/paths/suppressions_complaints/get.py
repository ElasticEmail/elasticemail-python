...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Suppression'], typing.List['Suppression']],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _suppressions_complaints_get_oapg(
        self,
...
class SuppressionsComplaintsGet(BaseApi):
    ...
    def suppressions_complaints_get(
        ...
        return self._suppressions_complaints_get_oapg(
