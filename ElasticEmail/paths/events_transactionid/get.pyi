...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RecipientEvent']:
            return RecipientEvent

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['RecipientEvent'], typing.List['RecipientEvent']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'RecipientEvent':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _events_by_transactionid_get_oapg(
        self,
...
class EventsByTransactionidGet(BaseApi):
    ...
    def events_by_transactionid_get(
        ...
        return self._events_by_transactionid_get_oapg(
