...
SchemaFor200ResponseBodyApplicationJson = FileInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _files_by_name_info_get_oapg(
        self,
...
class FilesByNameInfoGet(BaseApi):
    ...
    def files_by_name_info_get(
        ...
        return self._files_by_name_info_get_oapg(
