...
SchemaFor200ResponseBodyApplicationJson = VerificationFileResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _verifications_files_post_oapg(
        self,
...
class VerificationsFilesPost(BaseApi):
    ...
    def verifications_files_post(
        ...
        return self._verifications_files_post_oapg(
            body=body,
