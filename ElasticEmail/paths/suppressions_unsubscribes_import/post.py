...
class BaseApi(api_client.Api):
    @typing.overload
    def _suppressions_unsubscribes_import_post_oapg(
        self,
...
class SuppressionsUnsubscribesImportPost(BaseApi):
    ...
    def suppressions_unsubscribes_import_post(
        ...
        return self._suppressions_unsubscribes_import_post_oapg(
            body=body,
