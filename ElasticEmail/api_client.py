...
from ElasticEmail.exceptions import ApiTypeError, ApiValueError, ApiException
from ElasticEmail.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/4.0.23/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.campaigns_by_name_delete  # this is an instance of the class Endpoint
        api_instance.campaigns_by_name_delete()  # this invokes api_instance.campaigns_by_name_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.campaigns_by_name_delete.callable or self.callable in this class
