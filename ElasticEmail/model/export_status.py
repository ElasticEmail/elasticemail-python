...
class ExportStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Current status of the export.. if omitted defaults to "Error", must be one of ["Error", "Loading", "Ready", "Expired", ]  # noqa: E501

        Keyword Args:
            value (str): Current status of the export.. if omitted defaults to "Error", must be one of ["Error", "Loading", "Ready", "Expired", ]  # noqa: E501
