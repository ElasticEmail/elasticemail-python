...
class ConsentTracking(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ConsentTracking - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "Unknown", must be one of ["Unknown", "Allow", "Deny", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "Unknown", must be one of ["Unknown", "Allow", "Deny", ]  # noqa: E501
