...
class FilePayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, binary_content, *args, **kwargs):  # noqa: E501
        """FilePayload - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            content_type (str): Type of file's content (e.g. image/jpeg). [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, binary_content, *args, **kwargs):  # noqa: E501
        """FilePayload - a model defined in OpenAPI
