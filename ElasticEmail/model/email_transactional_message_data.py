...
def lazy_import():
    ...
    globals()['TransactionalRecipient'] = TransactionalRecipient


class EmailTransactionalMessageData(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'recipients': (TransactionalRecipient,),  # noqa: E501
    ...
    def _from_openapi_data(cls, recipients, *args, **kwargs):  # noqa: E501
        """EmailTransactionalMessageData - a model defined in OpenAPI
