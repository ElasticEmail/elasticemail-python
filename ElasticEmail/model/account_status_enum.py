...
class AccountStatusEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "Disabled", must be one of ["Disabled", "UnderReview", "NeverSignedIn", "Active", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "Disabled", must be one of ["Disabled", "UnderReview", "NeverSignedIn", "Active", ]  # noqa: E501
