...
class MessageAttachment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, binary_content, name, *args, **kwargs):  # noqa: E501
        """MessageAttachment - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, binary_content, name, *args, **kwargs):  # noqa: E501
        """MessageAttachment - a model defined in OpenAPI
