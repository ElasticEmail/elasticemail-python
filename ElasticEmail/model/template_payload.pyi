...
class TemplatePayload(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Name", "Subject", "Body", "TemplateScope", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Name", "Subject", "Body", "TemplateScope", ], str]):
