...
class DeliveryOptimizationType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """DeliveryOptimizationType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "None", must be one of ["None", "ToEngagedFirst", "ByOpenTime", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "None", must be one of ["None", "ToEngagedFirst", "ByOpenTime", ]  # noqa: E501
