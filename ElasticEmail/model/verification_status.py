...
class VerificationStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "Processing", must be one of ["Processing", "Ready", "Expired", "Verified", "Error", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "Processing", must be one of ["Processing", "Ready", "Expired", "Verified", "Error", ]  # noqa: E501
