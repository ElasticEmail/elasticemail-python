...
class EventType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Type of event. if omitted defaults to "Submission", must be one of ["Submission", "FailedAttempt", "Bounce", "Sent", "Open", "Click", "Unsubscribe", "Complaint", ]  # noqa: E501

        Keyword Args:
            value (str): Type of event. if omitted defaults to "Submission", must be one of ["Submission", "FailedAttempt", "Bounce", "Sent", "Open", "Click", "Unsubscribe", "Complaint", ]  # noqa: E501
