...
class Segment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Name", "Rule", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Name", "Rule", ], str]):
