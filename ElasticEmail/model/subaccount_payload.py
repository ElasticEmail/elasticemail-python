...
def lazy_import():
    ...
    globals()['SubaccountSettingsInfoPayload'] = SubaccountSettingsInfoPayload


class SubaccountPayload(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'send_activation': (bool,),  # noqa: E501
            'settings': (SubaccountSettingsInfoPayload,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'send_activation': 'SendActivation',  # noqa: E501
    ...
    def _from_openapi_data(cls, email, password, *args, **kwargs):  # noqa: E501
        """SubaccountPayload - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            send_activation (bool): True, if you want to send activation email to this Account to confirm the creation of a new SubAccount. Otherwise, false (SubAccount will immediately be Active).. [optional]  # noqa: E501
            settings (SubaccountSettingsInfoPayload): [optional]  # noqa: E501
        """
