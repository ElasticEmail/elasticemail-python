...
class TemplateType(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "RawHTML": "RAW_HTML",
            "DragDropEditor": "DRAG_DROP_EDITOR",
            "LandingPageEditor": "LANDING_PAGE_EDITOR",
    ...
    @schemas.classproperty
    def DRAG_DROP_EDITOR(cls):
        return cls("DragDropEditor")
    
    @schemas.classproperty
    def LANDING_PAGE_EDITOR(cls):
        return cls("LandingPageEditor")
    
    @schemas.classproperty
    def TEMPLATE_EDITOR(cls):
        return cls("TemplateEditor")
