...
class TemplateType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "RawHTML", must be one of ["RawHTML", "DragDropEditor", "LandingPageEditor", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "RawHTML", must be one of ["RawHTML", "DragDropEditor", "LandingPageEditor", ]  # noqa: E501
